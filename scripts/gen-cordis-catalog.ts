...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  knowledgeEmbedding: 'workbench.md',
  knowledgeStore: 'workbench.md',
  shell: 'shell.md',
  shellEnv: 'shell.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ArtifactCounts: 'workbench.md',
  Difficulty: 'workbench.md',
  DocumentListFilter: 'workbench.md',
  DocumentStatus: 'workbench.md',
  KnowledgeChunkInput: 'workbench.md',
  KnowledgeDocument: 'workbench.md',
  KnowledgeDocumentInput: 'workbench.md',
  KnowledgeEmbedding: 'workbench.md',
  KnowledgeMode: 'workbench.md',
  KnowledgeSearchRequest: 'workbench.md',
  KnowledgeSearchResult: 'workbench.md',
  KnowledgeSearchInput: 'workbench.md',
  SubmitDocumentInput: 'workbench.md',
  KnowledgeStore: 'workbench.md',
  TemplateArtifactInput: 'workbench.md',
  TemplateArtifactKind: 'workbench.md',
  TemplateArtifactRecord: 'workbench.md',
  TemplateMetadata: 'workbench.md',
