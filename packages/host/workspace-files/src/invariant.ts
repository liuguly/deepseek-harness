...
/**
 * No runtime invariant: every response is computed fresh from the host
 * filesystem on each call; the gateway owns no cache, watch, event stream,
 * or cross-call state to relate.
 */
