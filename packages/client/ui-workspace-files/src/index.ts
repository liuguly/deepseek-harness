/**
 * Workspace files explorer plugin, node half. Pure UI plugin: the empty apply
...
/** Host plugin body — no host-side behavior for the workspace files explorer plugin. */
