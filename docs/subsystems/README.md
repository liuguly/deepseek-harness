...
| [workbench.md](workbench.md) | the personal knowledge workbench: upload modes, ingest pipelines, the pgvector store seam, the embedding seam, and variant generation |
