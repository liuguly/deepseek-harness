...
需要：`knowledgeStore` · `knowledgeEmbedding` · `llm` · `connection`
...
来源：[`packages/workbench/knowledge/src/index.ts:88`](../packages/workbench/knowledge/src/index.ts)
...
来源：[`packages/workbench/knowledge-embedding-openai/src/index.ts:20`](../packages/workbench/knowledge-embedding-openai/src/index.ts)
...
来源：[`packages/workbench/knowledge-pgvector/src/index.ts:19`](../packages/workbench/knowledge-pgvector/src/index.ts)
